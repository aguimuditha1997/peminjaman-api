        ...
        <div class="content">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="padding: 8px; border-bottom: 1px solid #eee;">{{ $booking->room->name ?? 'N/A' }}</td>
                </tr>
                <tr>
                    <td style="padding: 8px; border-bottom: 1px solid #eee;"><strong>Waktu Mulai:</strong></td>
                    <td style="padding: 8px; border-bottom: 1px solid #eee;">{{ \Carbon\Carbon::parse($booking->start_time)->format('d M Y H:i') }}</td>
                </tr>
                <tr>
                    <td style="padding: 8px; border-bottom: 1px solid #eee;"><strong>Waktu Selesai:</strong></td>
                    <td style="padding: 8px; border-bottom: 1px solid #eee;">{{ \Carbon\Carbon::parse($booking->end_time)->format('d M Y H:i') }}</td>
                </tr>
                <tr>
